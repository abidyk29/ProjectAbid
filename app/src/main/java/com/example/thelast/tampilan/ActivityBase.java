...
import com.example.thelast.asycn.LoadSong;
import com.example.thelast.interfaces.SongListener;
import com.example.thelast.ownmodal.ItemMyPlayList;
import com.example.thelast.ownmodal.ItemSong;
import com.example.thelast.ownmodal.MessageEvent;
...
import com.example.thelast.utils.PausableRotateAnimation;
...
public class ActivityBase extends AppCompatActivity implements View.OnClickListener {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            if (Constant.isOnline) {
                Picasso.get()
                        ...
                        .resize(300, 300)
                        .placeholder(R.drawable.song_logo)
    ...
    public void setRepeat() {
        if (Constant.isRepeat) {
            ...
            iv_music_repeat.setImageDrawable(getResources().getDrawable(R.mipmap.repeat));
        } else {
            Constant.isRepeat = true;
            iv_music_repeat.setImageDrawable(getResources().getDrawable(R.mipmap.next));
        }
    }
    ...
    public void changeFav(Boolean isFav) {
        if (isFav) {
            iv_max_fav.setImageDrawable(getResources().getDrawable(R.mipmap.song_logo));
        } else {
            iv_max_fav.setImageDrawable(getResources().getDrawable(R.mipmap.song_logo));
        }
    }
    ...
    public void changePlayPauseIcon(Boolean isPlay) {
        if (!isPlay) {
            iv_music_play.setImageDrawable(getResources().getDrawable(R.mipmap.playing));
            iv_min_play.setImageDrawable(getResources().getDrawable(R.mipmap.playing));
        } else {
